...
"1.1.1"), c("httpuv", "1.5.4"), c("mime", "0.9"), "jsonlite", 
    ...
    "3.1.0"), c("htmltools", "0.4.0"), c("withr", "2.2.0"), c("leaflet.providers", 
    "1.9.0"), "shiny", c("colorspace", "1.4-1"), c("purrr", "0.3.4"
    ), c("yaml", "2.2.1"), c("labeling", "0.3"), c("munsell", 
    "0.5.0"), c("lazyeval", "0.2.2"), c("pkgconfig", "2.0.3"), 
    c("ellipsis", "0.3.1"), c("vctrs", "0.3.4"), c("tidyselect", 
    "1.1.0"), c("plogr", "0.2.0"), c("htmlwidgets", "1.5.1"), 
    c("base64enc", "0.1-3"), c("png", "0.1-7"), c("RColorBrewer", 
